...
# Install the required packages in the python directory
...
rm -f ../terraform/packages/ledaa_load_data_lambda_layer.zip

# Zip the contents of the python directory
zip -r ../terraform/packages/ledaa_load_data_lambda_layer.zip .
